...
function App() {
  ...
  const [form2, setForm2] = useState({ address: {line1: '', line2: '', city: '', state: '', zip: '' }, phoneNumber: '' });
  const [form3, setForm3] = useState({ creditCard: '', expDate: '', CVV: '', zip: '' });
  ...
  const pages = {
    ...
    4: <Confirm setPage={setPage} form1={form1} form2={form2} form3={form3}/>
  }
